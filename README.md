...
Running it yourself
Import workflow.json into n8n (⋯ → Import from File)
Add a Groq API credential to the LLM node
Add a Slack credential (bot token with chat:write) to the output node
Create #competitor-news in your workspace
Set the workflow timezone under ⋯ → Settings
Publish
